...
!function i(a,d,u){function c(t,e){if(!d[t]){if(!a[t]){var n="function"==typeof require&&require;if(!e&&n)return n(t,!0);if(s)return s(t,!0);var r=new Error("Cannot find module '"+t+"'");throw r.code="MODULE_NOT_FOUND",r}var o=d[t]={exports:{}};a[t][0].call(o.exports,function(e){return c(a[t][1][e]||e)},o,o.exports,i,a,d,u)}return d[t].exports}for(var s="function"==typeof require&&require,e=0;e<u.length;e++)c(u[e]);return c}({1:[function(e,t,n){"use strict";t.exports=e("./recorder-identify").RIdentify},{"./recorder-identify":2}],2:[function(e,t,n){"use strict";Object.defineProperty(n,"__esModule",{value:!0});var m="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};var r=n.RIdentify=function e(){var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};!function(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}(this,e),this.recorderConfig={numChannels:1,mimeType:"audio/wav",bitRate:16,sampleRate:16e3};var r=this;Object.assign(this.recorderConfig,t.config);var o=t.url||"/robot/rs/qa/asr",n=1e3*(t.time||21),i=0,a=null,d=null;HZRecorder.get(function(e){d=e}),document.getElementById("rIdentify").addEventListener("mousedown",function(){p()?f("IE浏览器不可录音！"):function(){u&&(clearInterval(u),u=null);d?(d.start(),setTimeout(function(){f(c+".")},200),u=setInterval(function(){f(c+=".")},800),i=new Date,a=setInterval(function(){i&&(new Date).getTime()-i.getTime()>=n&&s()},n)):f("未打开录音")}()}),document.getElementById("rIdentify").addEventListener("mouseup",function(){p()?f("IE浏览器不可录音！"):(s(),HZRecorder.get(function(e){d=e}))}),document.getElementById(document.getElementById("rIdentify").getAttribute("data-search-id")).addEventListener("change",function(e){});var u=null,c="";function s(){if(clearInterval(u),u=null,c="",d){d.stop();var e=d.getBlob();if(clearInterval(a),i&&(new Date).getTime()-i.getTime()<1e3)return void(i=0);if(i=0,e.size<2e4)return void f("录音太短不可用！");t=e,(n=new FormData).append("file",t,(new Date).getTime()+"."+r.recorderConfig.mimeType.split("/")[1]),function(e){(e=e||{}).type=e.type.toUpperCase()||"GET",e.url=e.url||"",e.async=e.async||!0,e.data=e.data||null,e.success=e.success||function(){},e.error=e.error||function(e){};var t=null;t=XMLHttpRequest?new XMLHttpRequest:new ActiveXObject("Microsoft.xhr");if(t.upload.addEventListener("progress",function(e){if(e.lengthComputable)(e.loaded/e.total*100).toFixed(0)},!1),t.addEventListener("readystatechange",function(){4==t.readyState&&200==t.status&&e.success(t.response)}),"POST"===e.type.toUpperCase())t.open(e.type,e.url,e.async),t.send(e.data);else if("GET"===e.type.toUpperCase()){var n=[];for(var r in e.data)n.push(r+"="+e.data[r]);var o=n.join("&");t.open(e.type,e.url+"?"+o,e.async),t.send(null)}}({url:o,type:"post",data:n,processData:!1,contentType:!1,success:function(e){if((e=JSON.parse(e)).data){var t=document.getElementById("rIdentify").getAttribute("data-search-id");t&&(document.getElementById(t).value=e.data,function(e,t){if("object"==(void 0===e?"undefined":m(e)))if(t=t.replace(/^on/i,""),document.all)t="on"+t,e.triggerEvent(t);else{var n=document.createEvent("HTMLEvents");n.initEvent(t,!0,!0),e.dispatchEvent(n)}}(document.getElementById(t),"change"))}},error:function(){}})}var t,n}var l=null;function f(e){var t=document.getElementById("rIdentifyTip");t&&(t.parentNode.removeChild(t),l&&clearTimeout(l)),(t=document.createElement("div")).id="rIdentifyTip",t.style.cssText="position: fixed; top: "+(document.getElementById("rIdentify").getBoundingClientRect().top-20)+"px;left: "+document.getElementById("rIdentify").getBoundingClientRect().left+"px;border-radius: 8px;margin-top: -15px;color: #fff;background-color: #409eff;padding: 5px 0;z-index: 2147483647;";var n=document.createElement("span");n.innerText=e,n.title=e,n.style.cssText="margin: 0 10px;white-space: nowrap;",t.appendChild(n),document.getElementById("rIdentify").parentNode.appendChild(t),l=setTimeout(function(){(t=document.getElementById("rIdentifyTip")).parentNode.removeChild(t)},1e3)}function p(){return window.navigator.userAgentbw&&0<=window.navigator.userAgentbw.indexOf("MSIE")||"ActiveXObject"in window}};new(n.default=r)},{}]},{},[1]);